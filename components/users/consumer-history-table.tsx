...
export interface ConsumerHistoryTableProps {
...
export function ConsumerHistoryTable({ history }: ConsumerHistoryTableProps) {
  const { columns } = translations.users.consumerDetail.history;
