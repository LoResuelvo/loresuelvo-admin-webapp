...
Then(
  ...
  async function (this: CustomWorld) {
    const skeleton = this.page
      ...
      .or(this.page.getByTestId("consumer-skeleton"));
    ...
    const isConsumer = (await this.page.getByTestId("consumer-skeleton").count()) > 0;
    if (isDetail || isPayments || isDiagnostic || isConsumer) {
